...
module.exports = async function() {
    ...
    */
    ...
    let nest = await IBNEST.at('0xCB35fE6Ba7E9a4d7aE1D34Cf32095ed9653301B5');
    ...
    let nestLedger = await NestLedger.at('0x19E46549DAA00AbaE8c4C30eBBe3C7c0f562Ff5C');
    ...
    let nTokenController = await NTokenController.at('0xF39AC8b44956371d2ad89092Db69b498900FF098');
    ...
    let nestVote = await NestVote.at('0x0D6fCCF3383E8701A6CE11239084207b334FB7e5');
    ...
    let ntokenMining = await NestMining.at('0x2Ea38A9a418402C7a2D245744DfD6baA83cfA80c');
    ...
    let nestPriceFacade = await NestPriceFacade.at('0xAF69fD1b77618087058fE9C1BaC3E31A7A3F1bC8');
    console.log('nestPriceFacade: ' + nestPriceFacade.address);
    //let nestRedeeming = await deployProxy(NestRedeeming, [nestGovernance.address], { initializer: 'initialize' });
    let nestRedeeming = await NestRedeeming.at('0xf48041aD10727937c721606B37223c0814a3357F');
    ...
    let nnIncome = await NNIncome.at('0xe0a5dea5f513b44BeDfA0b19fe5a3fbF07626E40');
